			...
			$('#dg').datagrid({   
			    ...
			    columns:[[    		           
			        ...
			        {field:'commend',title:'推荐商品',width:50,  
 			        ...
 			        {field:'open',title:'有效商品',width:50,  
						formatter: function(value,row,index){
 							if(value) {
 								return "<input type='checkbox' checked='checked' disabled='true'";
							} else {
 			        ...
 			        {field:'category.type',title:'所属商品类别',width:100, //category.type是商品类别
 			        	formatter: function(value,row,index){
			         ...
			         {field:'pic',title:'图片名称',width:150}
